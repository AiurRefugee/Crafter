  ...
  <var-paper class="slidebar" v-if="visible" :elevation="12">
    ...
    {{ El }}
      <var-paper :elevation="12" :radius="10" class="skeleton" style="align-items: center;" >
        ...
        <input type="file" ref="inputImage" v-if="props.type == 'image' && inputVisible" style="top:40% z-index: 99;">
        ...
        <input type="file" ref="inputVideo" v-if="props.type == 'video' && inputVisible" style="top:40% z-index: 99;">
